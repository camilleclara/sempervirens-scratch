 ...
 */
final class Version20200416143326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD typeprofil_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649C461B2E4 FOREIGN KEY (typeprofil_id) REFERENCES type_profil (id)');
        $this->addSql('CREATE INDEX IDX_8D93D649C461B2E4 ON user (typeprofil_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649C461B2E4 ON user');
        $this->addSql('ALTER TABLE user DROP typeprofil_id');
    }
}
